...
{
	return uid == from_kuid(&init_user_ns, current_fsuid()) || can_manipulate_uids();
}
...
static bool can_read_other_uid_stats(uid_t uid)
{
	...
	return in_egroup_p(xt_qtaguid_stats_file->gid)
		|| unlikely(!from_kuid(&init_user_ns, current_fsuid())) || uid == from_kuid(&init_user_ns, current_fsuid())
