...
/* Validate changes from /proc interface. */
static int proc_tcp_default_init_rcvwnd(ctl_table *ctl, int write,
					void __user *buffer,
					size_t *lenp, loff_t *ppos)
{
...
static struct ctl_table ipv4_table[] = {
	...
	{
		.procname       = "tcp_default_init_rcvwnd",
		.data           = &sysctl_tcp_default_init_rcvwnd,
		.maxlen         = sizeof(int),
		.mode           = 0644,
		.proc_handler   = proc_tcp_default_init_rcvwnd
	},
	{
		.procname	= "udp_mem",
		.data		= &sysctl_udp_mem,
