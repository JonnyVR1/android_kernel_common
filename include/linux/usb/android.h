...
extern int __init acm_function_add(struct usb_composite_dev *cdev,
	struct usb_configuration *c);
extern int __init adb_function_add(struct usb_composite_dev *cdev,
	struct usb_configuration *c);
extern int __init mass_storage_function_add(struct usb_composite_dev *cdev,
	struct usb_configuration *c);
