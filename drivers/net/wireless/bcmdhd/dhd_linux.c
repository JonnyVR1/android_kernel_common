...
dhd_attach(osl_t *osh, struct dhd_bus *bus, uint bus_hdrlen)
{
	...
	dhd->pub.wlfc_state_prealloc = MALLOC(dhd->pub.osh, sizeof(athost_wl_status_info_t));
	if (dhd->pub.wlfc_state_prealloc == NULL)
		DHD_ERROR(("%s: wlfc_state_prealloc failed\n", __FUNCTION__));
...
#ifdef PROP_TXSTATUS
#ifdef WLFC_STATE_PREALLOC
	if (dhd->pub.wlfc_state_prealloc)
		MFREE(dhd->pub.osh, dhd->pub.wlfc_state_prealloc, sizeof(athost_wl_status_info_t));
#endif /* WLFC_STATE_PREALLOC */
#endif /* PROP_TXSTATUS */
