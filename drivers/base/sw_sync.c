...
static struct sync_pt *sw_sync_pt_dup(struct sync_pt *sync_pt)
{
	...
	struct sw_sync_timeline *obj = (struct sw_sync_timeline *)sync_pt->parent;
...
static void sw_sync_print_obj(struct seq_file *s, struct sync_timeline *sync_timeline)
{
...
struct sw_sync_timeline *sw_sync_timeline_create(const char *name)
{
	struct sw_sync_timeline *obj = (struct sw_sync_timeline *)
		sync_timeline_create(&sw_sync_timeline_ops, sizeof(struct sw_sync_timeline),
				name);
