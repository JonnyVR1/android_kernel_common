...
/**
 * struct ion_mem_pool - mempool struct
 * @count:		number of items in the pool
 * @items:		list of items
 * @shrinker:		a shrinker for the items
 * @mutex:		lock protecting this struct and especially the count
 *			item list
 * @alloc:		function to be used to allocate memory when the pool
 *			is empty
 * @free:		function to be used to free memory back to the system
 *			when the shrinker fires
 * @gfp_mask:		gfp_mask to use from alloc
 * @priv:			any private data to be used from alloc/free
 *
 * Allows you to keep a pool of pre allocated memory to use from your heap.
 * Keeping a pool of memory that is ready for dma, ie any cached mapping have
