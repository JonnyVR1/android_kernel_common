...
struct inv_chip_config_s {
	...
	unsigned char compass_fifo_enable;
 ...
 *  @default_scan_mask:	scan mask used in channel scan.
 */
struct inv_chip_chan_info {
	const struct iio_chan_spec *channels;
	int num_channels;
	int default_scan_mask;
};
 ...
 *  @flick_ready:       flick ready signal.
 *  @orient_ready:      orientation ready signal.
 *  @tap_ready:         tap ready signal.
...
#define TIMESTAMP_FIFO_SIZE 16
	...
	unsigned char flick_ready;
	unsigned char orient_ready;
	unsigned char tap_ready;
	unsigned char orient_data;
	unsigned char tap_data;
	unsigned char self_test_run_once;
	void *sl_handle;
...
#define INV_MPU_SCAN_SUPPLY   0
#define INV_MPU_SCAN_GYRO_X   1
#define INV_MPU_SCAN_GYRO_Y   2
#define INV_MPU_SCAN_GYRO_Z   3
#define INV_MPU_SCAN_ACCL_X   4
#define INV_MPU_SCAN_ACCL_Y   5
#define INV_MPU_SCAN_ACCL_Z   6
#define INV_MPU_SCAN_MAGN_X   7
#define INV_MPU_SCAN_TEMP_X   7
#define INV_MPU_SCAN_MAGN_Y   8
#define INV_MPU_SCAN_TEMP_Y   8
#define INV_MPU_SCAN_MAGN_Z   9
#define INV_MPU_SCAN_TEMP_Z   9
#define INV_MPU_SCAN_TEMP     10
#define INV_MPU_SCAN_ADC_0    11
#define INV_MPU_SCAN_TIMESTAMP 12
