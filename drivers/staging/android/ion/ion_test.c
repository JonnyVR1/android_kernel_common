		...
		void __user *ptr, size_t offset, size_t size, bool write)
{
	...
	unsigned long offset_page = offset >> PAGE_SHIFT;
...
static long ion_test_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	...
	case ION_IOC_TEST_DMA_MAPPING:
	{
		ret = ion_handle_test_dma(test_data->dev, test_data->dma_buf,
				data.test_rw.ptr, data.test_rw.offset,
				data.test_rw.size, data.test_rw.write);
		break;
	}
...
int ion_test_open(struct inode *inode, struct file *file)
{
...
int ion_test_release(struct inode *inode, struct file *file)
{
