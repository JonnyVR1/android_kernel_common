...
extern struct usb_function_instance *alloc_inst(bool mtp_config);
extern struct usb_function *function_alloc(struct usb_function_instance *fi, bool mtp_config);
