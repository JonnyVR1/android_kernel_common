...
static int
__acc_function_bind(struct usb_configuration *c, struct usb_function *f, bool configfs)
{
...
static struct usb_function_instance *acc_alloc_inst(void)
{
	...
	if(acc_setup())
		printk("Error setting ACCESSORY\n");

	config_group_init_type_name(&fi_acc->func_inst.group, "", &acc_func_type);
	dev = _acc_dev;
