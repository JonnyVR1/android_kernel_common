...
#define AVTAB_OPNUM_AUDITDENY	0x0400
#define AVTAB_OPNUM		(AVTAB_OPNUM_ALLOWED | \
				AVTAB_OPNUM_AUDITALLOW | \
				AVTAB_OPNUM_AUDITDENY)
#define AVTAB_OPTYPE_ALLOWED	0x1000
#define AVTAB_OPTYPE_AUDITALLOW	0x2000
#define AVTAB_OPTYPE_AUDITDENY	0x4000
#define AVTAB_OPTYPE		(AVTAB_OPTYPE_ALLOWED | \
				AVTAB_OPTYPE_AUDITALLOW | \
				AVTAB_OPTYPE_AUDITDENY)
...
struct avtab_datum {
	union {
		...
		struct avtab_operation *ops; /* array of allowed ioctl operations */
	} u;
};
