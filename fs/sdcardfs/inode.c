...
static void remove_others(struct sdcardfs_sb_info *my_sbi, struct inode *old_lower_inode, struct inode *old_lower_inode_parent, userid_t id)
{
...
static void rename_others(struct sdcardfs_sb_info *my_sbi, struct dentry *upper_new_parent, struct dentry *lower_new_dir_dentry, userid_t new_id, struct dentry *lower_old_dir_dentry, userid_t old_id, struct dentry *lower_old_dentry, struct dentry *new_dentry)
{
			 ...
			 struct inode *new_dir, struct dentry *new_dentry)
{
	...
	rename_others(SDCARDFS_SB(old_dir->i_sb)/**/, new_parent, lower_new_dir_dentry, SDCARDFS_I(new_dir)->userid, lower_old_dir_dentry, SDCARDFS_I(old_dir)->userid, lower_old_dentry, new_dentry);
	dput(new_parent);
out:
