 ...
 * This is imilar to the tried and tested mechanism used in yaffs direct.
 *
 * A search context iterates along a doubly linked list of siblings in the
 * directory. If the iterating object is deleted then this will corrupt
 * the list iteration, likely causing a crash. The search context fixest
...
/*
 * yaffs_NewSearch creates a new search context, initialise it and
 * add it to the device's search context list.
 *
...
/*
 * yaffs_SearchAdvance() moves a search context to the next entry.
...
static void yaffs_RemoveObjectCallback(yaffs_Object *obj)
{
         ...
         * If any are the one being removed, then advance the sc to
